...
public class SimpleCanvas extends JPanel implements MouseListener, MouseMotionListener {
	...
	public BufferedImage[][] loadHumanSprites(String filename) {
		...
		// load up facing
		spriteArray[2][0] = spriteSheet.getSubimage(100, 234, 50, 80);

		// load down facing
		spriteArray[3][0] = spriteSheet.getSubimage(100, 160, 50, 78);
		
		
		//load another image
				//spriteArray[4][0] = spriteSheet.
	...
	public void drawZombie(Graphics2D g, Zombie z) {
		...
		r.setRect(locationx-5, locationy-18, 25, 57);
		//String s = r.toString();
