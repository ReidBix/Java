...
public class Geometry {
	...
	// ACTIVITY 3 & 4 - Add your new methods up here
	...
	public static void main(String[] args) {
		...
		do {
			// ACTIVITY 3 - Call the printMenu method here
			Geometry.printMenu();
			...
			case 1:
				...
				value = Geometry.circleArea(radius);
				// variable
			...
			case 2:
				...
				// call the rectangleArea method and store the result in the
				value = Geometry.rectangleArea(length, width);
			...
			case 3:
				...
				// call the triangleArea method and store the result in the
				// value variable
				value = Geometry.triangleArea(base, height);
			...
			case 4:
				System.out.print("Enter the radius of the circle:  ");
				radius = keyboard.nextDouble();
				// call the circumference method and store the result in the
				// value variable
				value = Geometry.circleCircumference(radius);
			...
			case 5:
				...
				// variable
				value = Geometry.rectanglePerimeter(length, width);
			...
			case 6:
				...
				// call the perimeter method and store the result in the value
				// variable
				value = Geometry.trianglePerimeter(side1, side2, side3);
			...
			keyboard.nextLine(); // consumes the new line character after the
									// number
