...
public class Song implements Comparable<Song>, Playable {
	...
	/**
	 * 
	 * @return Returns the minutes of the song.
	 */
	...
	/**
	 * 
	 * @return Returns the seconds in the song
	 */
	...
	/**
	 * 
	 * @return Returns the total length of the song in seconds
	 */
	...
	public boolean equals(Object o) {
		if (o instanceof Song) {
			Song s = (Song) o;
			boolean isEqual = this.fileName.equals(s.getFileName());
			return isEqual;
		}
		return false;
	}
	// CANNOT COMPARE TITLE OR ARTIST, CAN COMPARE FILENAME
	...
	/**
	 * Returns an integer that represents how different two songs are based on
	 * their author, their title, then their length.
	 */
